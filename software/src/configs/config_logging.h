...
#define LOGGING_CLK_GENERATOR GCLK_GENERATOR_3;
#define LOGGING_BAUDRATE      115200
#define LOGGING_MUX_SETTING   USART_RX_3_TX_0_XCK_1
#define LOGGING_PINMUX_PAD0   PINMUX_PA22C_SERCOM1_PAD0
#define LOGGING_PINMUX_PAD1   PINMUX_UNUSED
#define LOGGING_PINMUX_PAD2   PINMUX_UNUSED
